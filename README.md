...
probably the same thing those who are using the console for the breakout use. You can check out the code of my powder toy clone, its an open repo in my github. I thought in my case made much more sense to use this function to check for collisions than a using a grid.
