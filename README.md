...
* There's another readme, kinda long, in the previous commits. You can read that if you want, there's more information about this project, but I'm going to write in here
  ...
  Why am I telling this to you? We'll I dont want to fail, and I rather be honest about it. The way I see it, is that it's basically the same as I had, but instead of having
